// Package plugin defines the plugin interfaces for agent-engine.
//
// All extended capabilities (session, context, memory, auto-learn, tools,
// approval, checkpoint, observe) are defined here as Go interfaces. The
// engine core (engine/) depends only on these interfaces, never on concrete
// implementations.
//
// This package has a single dependency: github.com/hycjack/crux-ai/core.
// It does NOT depend on engine/, defaults/, or any other internal package.
//
...
// possible backend for ToolPlugin. See agent-engine-abstract.md for details.
package plugin
