...
func WebFetch() engine.AgentTool {
...
func executeWebFetch(ctx context.Context, toolCallID string, params json.RawMessage, onUpdate func(json.RawMessage)) (engine.AgentToolResult, error) {
