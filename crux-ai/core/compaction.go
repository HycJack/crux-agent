...
// Implementations receive a real context.Context for cancellation and
// deadline propagation rather than the previous interface{} placeholder.
type Compactor interface {
	Compact(ctx context.Context, systemPrompt string, toSummarize []Message) (string, error)
}
